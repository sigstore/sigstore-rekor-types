...
class Signature(BaseModel):
    ...
    keyid: StrictStr | None = Field(
        default=None, description="optional id of the key used to create the signature"
    )
    sig: Base64Str = Field(..., description="signature of the payload")
    public_key: Base64Str = Field(
...
class Envelope(BaseModel):
    ...
    payload: Base64Str | None = Field(default=None, description="payload of the envelope")
