...
class Archive(BaseModel):
    ...
    content: Base64Str | None = Field(
        default=None, description="Specifies the archive inline within the document"
    )
...
class Archive1(BaseModel):
    ...
    content: Base64Str = Field(..., description="Specifies the archive inline within the document")
...
class JarV001Schema(BaseModel):
    ...
    signature: Signature | None = Field(
        default=None, description="Information about the included signature in the JAR file"
    )
