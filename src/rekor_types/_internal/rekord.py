...
class Data(BaseModel):
    ...
    content: Base64Str | None = Field(
        default=None, description="Specifies the content inline within the document"
    )
...
class Data1(BaseModel):
    ...
    hash: Hash1 | None = Field(
        default=None, description="Specifies the hash algorithm and value for the content"
    )
    content: Base64Str = Field(..., description="Specifies the content inline within the document")
