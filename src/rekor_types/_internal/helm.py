...
class Provenance1(BaseModel):
    ...
    signature: Signature | None = Field(
        default=None, description="Information about the included signature in the provenance file"
    )
    content: Base64Str = Field(
        ..., description="Specifies the content of the provenance file inline within the document"
    )
...
class Chart(BaseModel):
    ...
    hash: Hash | None = Field(
        default=None, description="Specifies the hash algorithm and value for the chart"
    )
